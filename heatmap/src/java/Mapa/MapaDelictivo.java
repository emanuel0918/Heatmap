 ...
 * @author Alumno
 */
@WebServlet(name = "MapaDelictivo", urlPatterns = {"/MapaDelictivo"})
public class MapaDelictivo extends HttpServlet {
            ...
            try {
                ...
                if (rLang.next()) {
                    ...
                    html = "<!DOCTYPE html>\n"
                            ...
                            + "<html>\n"
                            + "    <head>\n"
                            + "        <title>" + rLang.getString("sMapaDelictivo") + "</title>\n"
                            + "        <meta charset='UTF-8'>\n"
                    ...
                    html += "            var map;\n\n"
                            ...
                            + "                });\n"
                            + "\n" + vista.zonasDeRiesgo(coox, cooy, rLang.getString("sDelitosPorMes")) + vista.lugares(usr)
                            + "\n"
                ...
                Logger.getLogger(MapaDelictivo.class.getSimpleName()).log(Level.SEVERE, null, ex);
            }
