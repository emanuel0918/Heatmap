 ...
 * @author Alumno
 */
@WebServlet(name = "HeatMap", urlPatterns = {"/HeatMap"})
            ...
            try {
                ...
                if (rLang.next()) {
                    ...
                    html = "<!DOCTYPE html>\n"
                            ...
                            + "            <img class='desvanece2' id='img-index2' height='100%' width='100%'>\n"
                            + "            <img class='desvanece' id='img-index' height='100%' width='100%'>\n"
                            + "            <div class='body-index'>\n"
                            + "                <h1>" + rLang.getString("sBienvenido") + "</h1>\n"
                            + "                <p class='justified'>" + rLang.getString("sContenidoIndex") + "</p>\n"
                            + "            </div>\n"
                            + "        </div>\n"
